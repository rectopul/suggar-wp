...
function rmb_customize_sections($wp_customize)
{
    ...
    $wp_customize->add_section('media_middle', array(
        'title'    => __('Mídia Home', 'suggar'),
        'capability' => 'edit_theme_options',
        'description' => __('Selecione um arquivo de mídia para ser exibido no centro da home'),
        'priority' => 1,
        'panel'            => 'pampers_theme_options'
    ));
    ...
    $wp_customize->add_section('copyright_message', array(
        'title'    => __('Texto de copyright', 'suggar'),
        'capability' => 'edit_theme_options',
        'description' => __('Altere o texto de copyright'),
        'priority' => 1,
        'panel'            => 'pampers_theme_options'
    ));
...
function rmb_customize_settings($wp_customize)
{
    ...
    $wp_customize->add_setting('media_middle', array(
        'default'           => '',
        'transport' => 'refresh',
    ));
    ...
    $wp_customize->add_setting('logo_agency', array(
        'default'           => '',
        'transport' => 'refresh',
    ));

    $wp_customize->add_setting('logo_work', array(
        'default'           => '',
        'transport' => 'refresh',
    ));
}
...
function rmb_custom_controls($wp_customize)
{
    ...
    $wp_customize->add_control( 
		new WP_Customize_Media_Control( 
		  $wp_customize, 'logo_agency', 
		  	[
				'label' => __( 'Logo da Agência', 'theme_textdomain' ), 
				'section' => 'copyright_message', 
    ...
    $wp_customize->add_control( 
		new WP_Customize_Media_Control( 
		  $wp_customize, 'logo_work', 
		  	[
				'label' => __( 'Logo da empresa', 'theme_textdomain' ), 
				'section' => 'copyright_message', 
				'mime_type' => 'image', // other options, e.g. audio 
			]
	) );
    ...
    $wp_customize->add_control( 
		new WP_Customize_Media_Control( 
		  $wp_customize, 'media_middle', 
		  	[
				'label' => __( 'Video Setting', 'theme_textdomain' ), 
				'section' => 'media_middle', 
				'mime_type' => 'video', // other options, e.g. audio 
			]
	) );
	...
	$wp_customize->add_control('copyright_message', array(
        'type' => 'textarea',
        'section' => 'copyright_message', // // Add a default or your own section
        'label' => __('Texto de copyright'),
        'description' => __('Altere o texto de copyright.'),
    ));
